				...
				while (true) {
					...
					if (orderNum == 0) {
						...
						while (true) {
							...
							tableNum = sc.nextInt();
							if (tableNum == 0) {
								System.out.println("주문하기 취소되었습니다.");
								break;
							}
							...
							if (regYn == 1) {
								...
								System.out.println("주문하기 완료되었습니다.");
							} else {
								System.out.println("주문하기 취소되었습니다.");
								break;
							}
						...
						while (true) {
							...
							if (editOrderNum == 0) {
								System.out.println("주문수정 취소되었습니다.");
								break;
							}
							System.out.print("수량> ");
							count = sc.nextInt();
							...
							if (regYn == 1) {
								...
								System.out.println("주문수정 완료되었습니다.");
						...
						while (true) {
							...
							if (delOrderNum == 0) {
								System.out.println("주문삭제 취소되었습니다.");
								break;
							}
							...
							if (regYn == 1) {
								...
								System.out.println("주문삭제 완료되었습니다.");
				...
				while (true) {
					...
					if (mainNum == 0) {
						...
						while (true) {
							...
							int cId = sc.nextInt();
							if (cId == 0) {
								System.out.println("메뉴등록이 취소되었습니다.");
								break;
							}
					...
					while (true) {
						...
						if (staticMenuNum == 1) {
							...
							for (int i = 0; i < dSalesList.size(); i++) {
								System.out.println(
										dSalesList.get(i).getMenuName() + "\t\t" + dSalesList.get(i).getmenuQuantity()
												+ "\t\t" + dSalesList.get(i).getMenuPrice());
							}
							...
							for (int i = 0; i < dtotalSalesList.size(); i++) {
								System.out.println("총수량: " + dtotalSalesList.get(i).getmTotalQuantity() + " "
										+ "\t총금액: " + dtotalSalesList.get(i).getmTotalPrice() + " 원");
							}
							...
							for (int i = 0; i < salesHourList.size(); i++) {
								System.out.println(salesHourList.get(i).getOrderTime() + "\t\t"
										+ salesHourList.get(i).getOrderCount() + "\t\t"
										+ salesHourList.get(i).getSales());
							}
							System.out.println(
									"-------------------------------------------------------------------------------------------");
							System.out.println("*0.나가기");
							...
							for (CategorySalesVO vo : cSalesList) {
								System.out.println(
										vo.getCategoryName() + "\t\t" + vo.getQuantity() + "\t\t" + vo.getSales());
							}
